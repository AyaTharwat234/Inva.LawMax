...
```bash
dotnet dev-certs https -v -ep openiddict.pfx -p 1f64f2aa-4298-40dd-947a-233778cf8ba8
```

> `1f64f2aa-4298-40dd-947a-233778cf8ba8` is the password of the certificate, you can change it to any password you want.
