...
```bash
dotnet dev-certs https -v -ep openiddict.pfx -p 53e9e6cb-d75a-4992-b28e-2e0cc28436a5
```

> `53e9e6cb-d75a-4992-b28e-2e0cc28436a5` is the password of the certificate, you can change it to any password you want.
